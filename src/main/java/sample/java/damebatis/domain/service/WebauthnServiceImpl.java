...
import sample.java.damebatis.domain.dto.AllowCredential;
import sample.java.damebatis.domain.dto.CreateUserDto;
import sample.java.damebatis.domain.dto.FidoUser;
import sample.java.damebatis.domain.dto.LoginUserDto;
import sample.java.damebatis.domain.dto.Rp;
import sample.java.damebatis.domain.dto.UserAuthenticationOption;
import sample.java.damebatis.domain.dto.UserEntity;
import sample.java.damebatis.domain.dto.ValidateCredentialDto;
import sample.java.damebatis.domain.exception.UserException;
import sample.java.damebatis.domain.repository.UserRepository;
import sample.java.damebatis.domain.util.UuidUtil;
...
public class WebauthnServiceImpl implements WebauthnService {
  ...
  //    //    List<String> transports = new ArrayList<>(Arrays.asList("usb", "nfc", "ble",
  // "internal"));
  //    //    List<String> transports = new ArrayList<>(Arrays.asList("internal", "usb", "nfc",
  // "ble"));
  ...
  //    //    Set<String> transports = new HashSet<>(Arrays.asList("internal", "usb", "nfc",
  // "ble"));
  ...
  //        new RegistrationRequest(attestationObject, clientDataJSON, clientExtensionJSON,
  // transports);
  //    RegistrationParameters registrationParameters =
  //        new RegistrationParameters(
  //            serverProperty, userVerificationRequired, userPresenceRequired,
  ...
  //    return new AuthenticatorImpl( // You may create your own Authenticator implementation to
  // save
