...
package sample.java.damebatis.domain.util;
...
class ServerEndpointFilterUtil {
  ...
  //    }
  //
  //    void writeResponse(HttpServletResponse httpServletResponse, ServerResponse response) throws
  // IOException {
  ...
  //    }
  //
  //    void writeErrorResponse(HttpServletResponse httpServletResponse, RuntimeException e) throws
  // IOException {
  ...
  //        } else if (e instanceof AuthenticationException || e instanceof
  ...
  //        try {
  //            UsernameEncodedChallengeEnvelope envelope =
  // cborConverter.readValue(challenge.getValue(), UsernameEncodedChallengeEnvelope.class);
  ...
  //    }
  //
  //    Challenge encodeUserVerification(Challenge challenge, UserVerificationRequirement
  // userVerification) {
  //        UserVerificationEncodedChallengeEnvelope envelope = new
  // UserVerificationEncodedChallengeEnvelope();
  //        envelope.setChallenge(challenge.getValue());
  ...
  //        try {
  //            UserVerificationEncodedChallengeEnvelope envelope =
  // cborConverter.readValue(challenge.getValue(), UserVerificationEncodedChallengeEnvelope.class);
